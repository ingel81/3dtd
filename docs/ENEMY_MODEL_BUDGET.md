...
Position aus der VAT (RGBA32F, 16 Byte). Pro Frame kostet ein Gegnertyp:

- **Vertex-Last** = VAT-Vertices × lebende Instanzen.
- **VAT-Lesezugriffe** = Vertex-Last × 16 Byte. Für 2.000 zombie_v2 sind das rechnerisch
  rund 1 GB pro Frame, für 2.000 alte Zombies 145 MB. Caches senken beides, das Verhältnis
  bleibt.
...
- **VAT-Speicher** = Texturbreite × Texturhöhe × 16 Byte. Die Breite ist die Vertexzahl
...
Blender; das Ergebnis mit `npm run model-budget` nachmessen.
...
Gegner der größten Welle gleichzeitig leben.
