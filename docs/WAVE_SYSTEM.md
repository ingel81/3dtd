...
| Gegner | `renderers/instanced-enemy/vat-material.ts` | Randleuchten im VAT-Shader über einen Uniform, den alle Typen teilen, Kopf, Ringe und Schwanz des Wurms eingeschlossen ([INSTANCED_ENEMY_RENDERING.md](INSTANCED_ENEMY_RENDERING.md#blutmond)) |
