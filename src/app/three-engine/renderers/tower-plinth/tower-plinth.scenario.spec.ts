...
import { createTestManagers, createMockOsmService, createMockResearchStore, TEST_PATH } from '../../../integration/test-helpers';
...
function setup() {
  ...
  const manager = new TowerManager(m.eventBus, createMockOsmService(), createMockResearchStore());
