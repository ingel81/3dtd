      ...
      <div class="td-layer-menu-wrapper">
        <div class="td-layer-toggles" [class.expanded]="uiStore.layerMenuExpanded()">
          <button class="td-layer-btn"
                  ...
                  matTooltip="Route Grid Overlay. Fill: grey no tower, green covered. Outline: white cell, orange on the ground under a roof, blue bridge deck, yellow tunnel or covered passage, pink no height sample (a tower's LOS view leaves it out). Brighter: centre line"
                  matTooltipPosition="left"
