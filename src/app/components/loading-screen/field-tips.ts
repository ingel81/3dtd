...
export const FIELD_TIPS: FieldTip[] = [
  ...
  {
    html: 'Frost slows and chips, but its damage is tiny, so treat it as a slower. Stack it in front of a <b style="color:var(--td-gold-light)">high-DPS</b> tower so frozen enemies sit in the kill zone longer.',
  },
  {
