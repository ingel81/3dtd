...
export interface WaveResult {
   ...
   *
   * The bot server treats this as the authoritative source for "did the
  ...
  // === COMPUTED REWARD (set by bot server or local) ===
  reward?: number;
}
...
export interface WaveOutcome {
   ...
   * fairness gate books them as leaks, see leakRatio.
   */
  abilityKills?: number;
