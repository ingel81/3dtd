...
import { createEmptySnapshot, GameStateSnapshot } from '../../../core/models/game-state-snapshot';
import { getAllResearchIds } from '../../../../configs/research/research-tree.config';
import { HERO } from '../../../../configs/hero.config';

const SKILLS: BotSkillLevel[] = ['beginner', 'casual', 'strategist', 'meta'];
...
describe('ResearchPickStrategy', () => {
  ...
  it('picks something else while it is available', () => {
    ...
    for (const skill of ['strategist', 'meta'] as BotSkillLevel[]) {
